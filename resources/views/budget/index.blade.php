...
<section>
    <div class="container-fluid">
        @if(in_array("quotes-add", $all_permission))
            <a href="{{route('budget.create')}}" class="btn btn-info"><i class="fa fa-plus"></i> {{trans('file.Add budget')}}</a>
        @endif
    </div>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                <div class="col-md-3">
                    ...
                    {{ Form::open(['route' => 'budget.sendmail', 'method' => 'post', 'class' => 'sendmail-form'] ) }}
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;">{{trans('file.budget Details')}}</i>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $("ul#budget").siblings('a').attr('aria-expanded','true');
    $("ul#budget").addClass("show");
    $("ul#budget #budget-list-menu").addClass("active");
    ...
    function quotationDetails(quotation){
        ...
        $.get('budget/product_quotation/' + quotation[13], function(data){
