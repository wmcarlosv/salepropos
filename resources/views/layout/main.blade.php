          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              @endif
                ...
                @if($index_permission_active)
              <li><a href="#work" aria-expanded="false" data-toggle="collapse"> <i class="ion-clipboard"></i><span>{{trans('file.Work')}}</span><span></a>
                <ul id="work" class="collapse list-unstyled ">
                  <li id="work-list-menu"><a href="{{route('work.index')}}">{{trans('file.Work List')}}</a></li>
                  <?php 
                  ...
                  ?>
                  @if($add_permission_active)
                  <li id="work-create-menu"><a href="{{route('work.create')}}">{{trans('file.Add Work')}}</a></li>
                  @endif
                </ul>
              </li>
              @endif
